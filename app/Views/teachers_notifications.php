...
<div class="content-wrapper" style="background: transparent;">
 ...
 <a href="<?= base_url('teachers-notifications-clear') ?>" class="btn btn-outline-danger btn-sm"
 ...
 <td>
 <a href="<?= base_url('teachers-notifications-delete/' . $s['id']) ?>" class="btn btn-outline-danger btn-sm"
